	...
	<section class="container">
		<div class="contents">
			<div class="visualArea company">
				...
				<p role="text" class="pageTxt">1981년 정부가 출자한 한국기술개발을 모태로 한 KTB는 이제 증권, 자산운용, VC, PE 등 금융 전반을 아우르는 그룹으로 성장해 왔습니다.</p>
				<p role="text" class="pageTxt">오직 고객의 더 큰 성공, 더 깊은 신뢰를 위해 KTB그룹의 모든 임직원은 원칙을 준수하고, 혁신을 선도해 나가겠습니다.</p>
			</div>
			...
			<div id="CI1T2" class="tabCont">
				...
				<div class="affArea">
					<div class="affImg"><img src="/static/mobile/kr/images/contents/img_affiliates.png" alt=""></div>
					<ul class="affList">
	...
	<div class="layerPop" id="pop2">
		<div class="layerContainer">
			...
			<div class="layerCont" tabindex="0">
				...
				‘99년 설립되어 20여년간 지속 성장하고 있는 중견 종합자산운용사로 ‘18년말 기준 총 운용자산(AUM) 10.7조원*에 달하고 있습니다. 특히, 2016년 멀티에셋본부, 대체투자부문 신설을 통해 신규 비즈니스에서 두각을 나타내고 있습니다.<br><br>1등주 펀드, 코스닥벤처펀드, 코넥스하이일드 펀드 등 다수의 HIT 공모펀드를 출시 및 운용하여 시장의 선도적인 역할을 수행하고 있으며, EMP/NPL/자산배분형 등 중위험&middot;중수익 상품 출시를 지속 확대하고 있습니다.<br><br>대체투자부문은 전세계 핵심 상업지구에서 1.9조원 규모의 국내외 부동산 딜을 성사시켰으며, ‘18년말 현재 2.6조원의 대체투자자산을 운용하고 있습니다.<br><br>
				<p class="info">2018.12월말 기준, 금융투자협회</p>
			</div>
		</div>
		<button type="button" class="layerClose">닫기</button>
	</div>
	...
	<div class="layerPop" id="pop3">
		<div class="layerContainer">
			...
			<div class="layerCont" tabindex="0">
				...
				국내 최고 수준의 업력 및 투자경험을 보유한 한국을 대표하는 벤처캐피탈입니다.<br>‘18년 말 기준 약 8,800억원의 운용자산(AUM)을 보유 중이며, ‘17년 VC 투자실적 1위를 달성했습니다*<br><br>
				‘00년 국내 VC중 최초로 중국시장에 진출, 9년 연속 중국 내 Top VC 50위 안에 선정되는 등 First Mover로서 성공적인 운용성과를 시현하고 있으며, 미주, 중국, 일본, 동남아시아 등 다양한 글로벌 투자 Track record 및 네트워크를 확보하고 있습니다.<br><br>
				<p class="info">2018.12월말 기준, 한국벤처캐피탈협회</p>
			</div>
		</div>
		<button type="button" class="layerClose">닫기</button>
	</div>
	...
	<div class="layerPop" id="pop5">
		<div class="layerContainer">
			...
			<div class="layerCont" tabindex="0">
				...
				‘08년 8월 KTB투자증권이 인수한 태국 현지 증권사입니다.<br><br>
				최근 고객 자산관리를 위한 WM본부, ECM, DCM 업무수행을 위한 IB 본부 등 관련 조직을 확대하여 종합증권사로서의 위상을 제고하고 있습니다.<br>또한, ‘18년 하반기 자산운용사, Reits운용사를 자회사로 설립하는 등 태국 내 유일한 한국계 금융투자회사로 성장하고 있습니다.
			</div>
		</div>
		<button type="button" class="layerClose">닫기</button>
	</div>
	...
	<div class="layerPop" id="pop6">
		<div class="layerContainer">
			...
			<div class="layerCont" tabindex="0">
				...
				‘88년 6월 미국 실리콘 밸리의 심장부인<br>California Palo Alto에 설립된<br>KTB의 첫번째 해외 네트워크입니다.<br><br>
				1,000억원 규모의 미국 투자 레코드를<br>보유하고 있으며, 최근 계열사인<br>KTB네트워크와 협업하여 미국, 캐나다 등 북미지역의 벤처기업을 발굴하고 있습니다.
			</div>
		</div>
		<button type="button" class="layerClose">닫기</button>
	</div>
	...
	<div class="layerPop" id="pop7">
		<div class="layerContainer">
			...
			<div class="layerCont" tabindex="0">
				...
				‘99년 나라신용정보로 출발한 KTB신용정보는 ‘01년 KTB투자증권의 계열사로 편입 되었습니다.<br><br>
				채권추심, 신용조사, 민원서류발급대행, 부동산관리업무 등을 수행하는 회사로서, 20년 가까이 예금보험공사의 채권추심담당사로 선정될 만큼 전문성을 보유하고 있습니다.
				<p class="txtGuide">예금보험공사 채권 수임기간 : ‘01년 ~ ‘19년 1월 현재</p>
			</div>
		</div>
		<button type="button" class="layerClose">닫기</button>
	</div>
