...
<%@ include file="/WEB-INF/jsp/common/import/taglib.jspf" %>
	<section class="container">
		<div class="contents">
			...
			<!-- //mainSwipe -->
			<div class="srvIntro">
				<p class="srvTit"><em>Our Fund Status</em><br>Grow Together with<br>KTB Network.</p>
					...
					<ul class="fundStatus">
						<li>
							<div class="contBox">
								...
								<dl>
									<dt>Funds exited</dt><dd class="num01">52</dd>
									<dt>Capital Raised<em>(Unit : USDMillion)</em></dt><dd class="num02">1.1</dd>
									<dt>Total Paid Out<em>(Unit : USDMillion)</em></dt><dd class="num02">260</dd>
									<dt>IRR<em>(Unit : %)</em></dt><dd class="num02">20.02</dd>
								</dl>
						...
						<li>
							<div class="contBox">
								...
								<dl>
									<dt>Funds Active</dt><dd class="num01">15</dd>
									<dt>Capital Pledged<em>(Unit : USDMillion)</em></dt><dd class="num02">752</dd>
									<dt>Capital Deployed<em>(Unit : USDMillion)</em></dt><dd class="num02">462</dd>
									<dt>IRR(e)<em>(Unit : %)</em></dt><dd class="num02">16.91</dd>
								</dl>
		...
		<div class="layerContainer">
			...
			<div class="layerCont" tabindex="0">
				<ul class="listDep2">
					<li>The present 2018.12.31</li>
					<li>based on funds exited from Jan 1, 2000</li>
	...
	<div class="layerPop open" id="MAL2">
		<div class="layerContainer">
			...
			<div class="layerCont" tabindex="0">
				<ul class="listDep2">
					<li>The present 2018.12.31</li>
					<li>Excludes funds currently exiting</li>
					<li>IRR(e) : Include Performance Remuneration , Weighted average return on payments</li>
				</ul>
			</div>
		</div>
		<button type="button" class="layerClose">close</button>
