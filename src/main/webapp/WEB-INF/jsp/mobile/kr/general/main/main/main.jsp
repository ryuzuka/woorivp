					...
					<ul class="fundStatus">
						<li>
							<div class="contBox">
								...
								<dl>
									<dt>펀드 수</dt><dd>52<span>개</span></dd>
									<dt>납입총액</dt><dd>12,642<span>억원</span></dd>
									<dt>분배총액</dt><dd>19,649<span>억원</span></dd>
									<dt>IRR</dt><dd>20.02<span>%</span></dd>
								</dl>
						...
						<li>
							<div class="contBox">
								...
								<dl>
									<dt>펀드 수</dt><dd>15<span>개</span></dd>
									<dt>약정총액</dt><dd>8,535<span>억원</span></dd>
									<dt>투자총액</dt><dd>5,252<span>억원</span></dd>
									<dt>IRR(e)</dt><dd>16.91<span>%</span></dd>
								</dl>
		...
		<div class="layerContainer">
			...
			<div class="layerCont" tabindex="0">
				<ul class="listDep2">
					<li>2018.12.31 현재</li>
					<li>청산중인 펀드 제외</li>
					<li>IRR(e) : 성과보수 포함, 납입금액 가중평균 수익률</li>
				</ul>
			</div>
		</div>
		<button type="button" class="layerClose">닫기</button>
